...
namespace Logger.Core
{
            ...
            IShell
    {
        ...
        public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register("ViewModel", typeof(IViewModel), typeof(RibbonShell), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsArrange | FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.Inherits, RibbonShell.OnViewModelChanged));
        ...
        {
            ( (RibbonShell)sender ).DataContext = e.NewValue;
        }
        ...
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Disabling shell: {0}", this.GetType().Name);
            this.EnableWindow(false);
        }

        protected virtual void Enable ()
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Enabling shell: {0}", this.GetType().Name);
            this.EnableWindow(true);
        }

        protected virtual void Initialize ()
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Initializing shell: {0}", this.GetType().Name);
        ...
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Maximizing shell: {0}", this.GetType().Name);
            this.MaximizeWindow();
        }

        protected virtual void Minimize ()
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Minimizing shell: {0}", this.GetType().Name);
            this.MinimizeWindow();
        }

        protected virtual void MoveToBackground ()
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Moving shell to background: {0}", this.GetType().Name);
            this.MoveWindowToBackground();
        }

        protected virtual void MoveToForeground ()
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Moving shell to foreground: {0}", this.GetType().Name);
            this.MoveWindowToForeground();
        }

        protected virtual void MoveToPrimaryScreen ()
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Moving shell to primary screen: {0} -> [P]", this.GetType().Name);
            this.MoveWindowToPrimaryScreen();
        }

        protected virtual void MoveToScreen (int screenIndex)
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Moving shell to screen: {0} -> [{1}]", this.GetType().Name, screenIndex);
            this.MoveWindowToScreen(screenIndex);
        }

        protected virtual void MoveToScreen (Screen screen)
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Moving shell to screen: {0} -> [{1}]", this.GetType().Name, screen == null ? "[null]" : screen.DeviceName);
        ...
        protected virtual void SetHideMouseCursor (bool hideMosueCursor)
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Hiding mouse cursor of shell: {0} -> [{1}]", this.GetType().Name, hideMosueCursor);
            this.ForceCursor = hideMosueCursor;
            this.Cursor = hideMosueCursor ? Cursors.None : null;
        }

        protected virtual void SetRectangle (Rect rectangle)
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Setting rectangle of shell: {0} -> [{1}]", this.GetType().Name, rectangle);
        ...
        {
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Setting state of shell: {0} -> [{1}]", this.GetType().Name, state);
        ...
        protected override void OnClosing (CancelEventArgs e)
        {
            ...
            this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Attempting to close shell: {0}", this.GetType().Name);
        ...
        public IViewModel ViewModel
        {
            get
            {
                return (IViewModel)this.GetValue(RibbonShell.ViewModelProperty);
            }
            set
            {
                this.SetValue(RibbonShell.ViewModelProperty, value);
            }
        }
        ...
        void IShell.Hide ()
        {
            ...
            {
                this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Hiding shell: {0}", this.GetType().Name);
                this.Hide();
            }));
        }
        ...
        void IShell.SetHideMouseCursor (bool hideMosueCursor)
        {
            this.Dispatcher.BeginInvoke(new Action<bool>(this.SetHideMouseCursor), hideMosueCursor);
        }
        ...
        void IShell.SetParent (IShell parentShell)
        {
            ...
            {
                this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Setting parent of shell: {0} <- {1}", this.GetType().Name, x == null ? "[null]" : x.ToString());
        ...
        void IShell.Show ()
        {
            this.Dispatcher.BeginInvoke(new Action(() =>
            {
                this.LogManager.Value.Log(typeof(RibbonShell).Name, LogLevel.Debug, "Showing shell: {0}", this.GetType().Name);
                this.Show();
            }));
        }
